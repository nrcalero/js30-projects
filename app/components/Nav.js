    ...
    return (
      <nav>
        <div className="nav-wrapper">
          <a href="#" className="brand-logo" style={{'margin-left': '350px'}}>JS30 Projects</a>
        ...
        <ul id="nav-mobile" className="sidenav sidenav-fixed" style={{'transform': 'translateX(0px)'}}>        
          ...
          <li className="no-padding">
            <ul className="collapsible collapsible-accordion">
              <li className="bold"><a className="collapsible-header waves-effect waves-teal" tabIndex="0">CSS</a>
              ...
              <li className="bold active"><a className="collapsible-header waves-effect waves-teal" tabIndex="0">Components</a>
                <div className="collapsible-body" style={{'display': 'block'}}>
                  <ul>
                    ...
                    <li className="active"><a href="navbar.html">Navbar</a></li>
                    <li><a href="pagination.html">Pagination</a></li>
                    <li><a href="preloader.html">Preloader</a></li>
                  </ul>
                </div>
              </li>
              <li className="bold"><a className="collapsible-header waves-effect waves-teal" tabIndex="0">JavaScript</a>
                <div className="collapsible-body">
                  <ul>
              ...
              <li className="bold"><a className="collapsible-header waves-effect waves-teal" tabIndex="0">Forms</a>
                <div className="collapsible-body">
                  <ul>
          ...
          <li className="bold"><a href="themes.html" className="waves-effect waves-teal">Themes<span data-badge-caption="updated" className="new badge"></span></a></li>
        </ul>
      </nav>
    )
  }
